    ...
    return (
        <div className='bg-sky-500 bg-opacity-5'>
            <div className="flex justify-center items-center py-10 gap-5">
                <a href="https://github.com/RegionX-Labs" className="flex justify-center items-center cursor-pointer">
                ...
                <a href="https://twitter.com/RegionXLabs" className="flex justify-center items-center cursor-pointer">
                ...
                <a href="https://medium.com/@regionx" className="flex justify-center items-center cursor-pointer">
